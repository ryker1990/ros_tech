(function () {
  ...
  module.exports = {
    ...
    disconnect: function () {
      ...
      if (ssid !== null) {
        try {
          os_instructions.disconnect.call(CXT, ssid);
          return {
            success: true,
            msg: "Successfully disconnected from " + ssid + " network"
          }
        } catch (e) {
          _msg = "Encountered an error while trying to disconnect from network: " + e;
          CXT.WiFiLog(_msg, true);
          return {
            success: false,
            msg: _msg
        ...
        return {
          success: false,
          msg: "WiFi is not connected to any network."
        }
      }
    }
  };
